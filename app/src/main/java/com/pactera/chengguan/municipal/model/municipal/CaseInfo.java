...
import com.pactera.chengguan.municipal.bean.municipal.CaseFlowBean;
...
public class CaseInfo implements Serializable{
    ...
    private String checkPoint;     //考核扣分
    private int operateUnitId; //作业单位id
    private String operateContent;  //作业内容
    private ArrayList<PicData> beforePic = new ArrayList<PicData>(); //处理前照片 时间-Url
    private ArrayList<PicData> afterPic = new ArrayList<PicData>();//处理后照片 时间-Url
    private ArrayList<PicData> beforeSmallPic = new ArrayList<PicData>(); //处理前的缩略图
    private ArrayList<PicData> afterSmallPic = new ArrayList<PicData>();  //处理后的缩略图
    ...
    public ArrayList<PicData> getBeforePic() {
        return beforePic;
    }

    public void setBeforePic(ArrayList<PicData> beforePic) {
        this.beforePic = beforePic;
    }

    public ArrayList<PicData> getAfterPic() {
        return afterPic;
    }

    public void setAfterPic(ArrayList<PicData> afterPic) {
        this.afterPic = afterPic;
    }

    public ArrayList<PicData> getBeforeSmallPic() {
        return beforeSmallPic;
    }

    public void setBeforeSmallPic(ArrayList<PicData> beforeSmallPic) {
        this.beforeSmallPic = beforeSmallPic;
    }

    public ArrayList<PicData> getAfterSmallPic() {
        return afterSmallPic;
    }

    public void setAfterSmallPic(ArrayList<PicData> afterSmallPic) {
        this.afterSmallPic = afterSmallPic;
    }
